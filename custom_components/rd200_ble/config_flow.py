...
class RD200ConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(
        ...
        for discovery_info in async_discovered_service_info(self.hass):
            ...
            if not (discovery_info.advertisement.local_name.startswith("FR:RU") or discovery_info.advertisement.local_name.startswith("FR:GI") or discovery_info.advertisement.local_name.startswith("FR:RE")):
                continue
